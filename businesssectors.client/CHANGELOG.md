...
- Create Angular project with ng: `ng new businesssectors.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`businesssectors.client.esproj`).
